...
const ClassroomDetail = () => {
  ...
  return (
    <div className="section-container">
      ...
      {/* ฟีเจอร์เสริม ตัวกรอง และช่องค้นหา */}
      ...
      <tr key={student?._id}>
        ...
        <td className="text-center">
          <div className="flex gap-2 justify-center">
            <button className="btn btn-warning"><BiSolidEdit size={20} /></button>
            <button className="btn btn-error"><AiOutlineDelete size={20} /></button>
          </div>
        </td>
      </tr>
    ))}
